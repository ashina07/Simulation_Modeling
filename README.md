...
For the remote repository, make a github repository named SimulationModeling, then do;

```bash
git remote add origin git@github.com:ashina07/SimulationModeling.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── SimulationModeling	<- Your notebooks and scripts will live in the main project folder
